  ...
  return (
    <div className="max-w-lg">
      ...
      <div className="flex items-center gap-2 text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-900 font-medium">{isEdit ? '编辑项目' : '创建项目'}</span>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-gray-200 divide-y divide-gray-100">
        <div className="px-6 py-5 space-y-5">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1.5">巡检模板</label>
            {templates.length === 0 ? (
              <p className="text-sm text-amber-600 flex items-center gap-1.5">
                ...
                暂无模板，请先
                <Link to="/templates/new" className="underline text-blue-600">创建模板</Link>
              </p>
            ) : (
              <select
                value={templateId}
